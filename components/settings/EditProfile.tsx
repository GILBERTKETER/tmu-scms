...
const StudentPortfolio: React.FC = () => {
    ...
    try {
      ...
      if (profileImageUrl) {
        const profileImageFile = new File(
          [],
          profileImageUrl.split("/").pop() || "profile.png",
          { type: "image/png" },
        );
      ...
      if (coverPhotoUrl) {
        const coverPhotoFile = new File(
          [],
          coverPhotoUrl.split("/").pop() || "cover.png",
          { type: "image/png" },
        );
  ...
  <FormItem label="Profile Image" field="personalInfo.profileImage">
      ...
      <Col span={12}>
        <FormItem label="Cover Photo" field="personalInfo.coverPhoto">
          <Upload
            listType="picture-card"
            limit={1}
            beforeUpload={(file) => {
                ...
                >
                        ...
                        <Col span={8}>
                          ...
                          >
                            <Select placeholder="Select platform">
                              ...
                              <Select.Option value="behance">
                                Behance
                              </Select.Option>
                              <Select.Option value="dribbble">
                                Dribbble
                              </Select.Option>
                              <Select.Option value="medium">
                                Medium
                              </Select.Option>
                              <Select.Option value="stackoverflow">
                                Stack Overflow
                              </Select.Option>
                  ...
                  >
                    <Paragraph type="secondary">
                      ...
                      <ul>
                        <li>
                          Ensure all profile URLs are correct and accessible
                        </li>
                        <li>
                          Keep usernames consistent across platforms when
                          possible
                        </li>
                        <li>
                          Add platforms relevant to your professional field
                        </li>
                        <li>
                          Make sure profiles are professional and up-to-date
                        </li>
                      </ul>
                    </Paragraph>
                  </Space>
              ...
              <Row justify="space-between" align="center">
                <Col>
                  <Space direction="vertical">
                    ...
                    <Space size="large">
                      {Array.isArray(
                        form.getFieldValue("socialMedia") as SocialMedia[],
                      ) &&
                        (
                          form.getFieldValue("socialMedia") as SocialMedia[]
                        ).map((social, index) => (
