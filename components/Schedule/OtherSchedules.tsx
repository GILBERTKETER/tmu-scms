...
import AddSchedule from "./AddModal"
...
const columns = [
  ...
  return (
    <div
      ...
      className="border"
    >
      <div className="my-10 px-4" style={{display:"flex", alignItems:"center", justifyContent:"space-between", width:"100%"}}>
        <strong className="text-primary" style={{fontSize:"20px"}}>Other Scheduled Activities</strong>
       <AddSchedule/>
      </div>
