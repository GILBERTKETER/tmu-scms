...
const Header = (props: {
  ...
  return (
    <header className="drop-shadow-1 bg-light sticky top-0 z-999 flex w-full dark:bg-boxdark dark:drop-shadow-none">
        ...
        <div className="hidden sm:block">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              ...
              >
                <svg
                  className="fill-current dark:fill-bg-dark-bg hover:fill-primary dark:hover:fill-primary"
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
                  fill="none"
