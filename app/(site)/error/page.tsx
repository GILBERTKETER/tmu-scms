...
export const metadata: Metadata = {
  title: "Error Page - Compliance Is Us",
  description: "Oops! It seems there’s an issue. Please check back later or contact support for assistance with compliance-related matters.",
  // other metadata
};
