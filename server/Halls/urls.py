...
from .views import AddHallView, halls_status, get_halls, update_hall, delete_hall, get_halls_all_details
urlpatterns = [
    ...
    path('hall-details/', get_halls_all_details, name='get hall'),
