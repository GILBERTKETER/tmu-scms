...
from .views import create_schedule,get_scheduled_classes, update_class_details, get_attendance_logs, verify_qrcode, generate_qrcode, check_in_students,check_in_students_rfid, update_rfid
urlpatterns = [
    ...
    path('update-rfid/', view=update_rfid, name='Rfid update'),
